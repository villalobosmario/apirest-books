...
import com.company.books.backend.dao.IUsuarioDao;
...
public class UsuarioService implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		...
		//Con esto se transforma la lista de rples a una GrantedAuthority
		 List<GrantedAuthority> authorities = usuario.getRoles()
         .stream().
         map(role -> new SimpleGrantedAuthority(role.getNombre())) //Se transforman los roles a GrantedAthority 
         .peek(authority -> log.info("Role: "+ authority.getAuthority()))//Aqui se logean las Authorities ques evayan encontrando
